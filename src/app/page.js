...
export default function Home() {
  return (
    ...
    >
      <div className="flex-1 flex justify-center items-start gap-y-5 flex-col px-4 xl:px-0 mb-24 xl:mb-0 xl:pl-0 text-white/80 text-xl xl:text-lg font-extralight">
        <motion.h1
