...
export default function Home() {
  return (
    ...
    >
      <div className="flex-1 flex justify-center items-start gap-y-5 flex-col px-4 xl:px-0 xl:pl-0 text-white/80 text-xl xl:text-lg font-extralight">
        <motion.h1
        ...
        <Link href={"/about"}>
          <motion.div
            variants={fadeIn("up", "tween", 0.2, 1)}
            className="btn btn-sm btn-accent w-[164px] mb-40 xl:mb-0"
          >
            about
          </motion.div>
        </Link>
